  ...
  return (
    <section className="md:px-[88px] lg:px-[180px] pt-[90px] pb-56">
      <div className="flex items-start gap-16 justify-between">
        ...
        {/* right side content */}
        <div className="flex 2/3 pt-16 bg-[#102125] rounded-3xl text-white font-sans overflow-hidden">
          <div className="bg-linear-to-b from-[#080A12] to-[#0C1423] px-6 pt-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="bg-[#8BD8B4 bg-linear-to-l from-[#6CA98A] to-[#8BD8B4] text-black px-5 py-2 rounded-md font-medium">
                  Connect Wallet
                </button>
              </div>
            </div>
