  ...
  return (
    ...
    >
      <foreignObject x={-175} y={-175} width={710} height={564}>
        <div
          style={{
            ...
            clipPath: "url(#bgblur_0_0_44_clip_path)",
            height: "100%",
            width: "100%",
          }}
        />
      ...
      <rect
        ...
        stroke="url(#paint1_linear_0_44)"
      />
      <defs>
        <clipPath id="bgblur_0_0_44_clip_path" transform="translate(175 175)">
          <rect x={0.5} y={0.5} width={359} height={213} rx={9.5} />
        </clipPath>
        <linearGradient
